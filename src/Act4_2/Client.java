...
public class Client {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Time Received : " + message); // Print the received message
            System.out.println("from : " + donneesRecues.getAddress() + ":" + donneesRecues.getPort()); // Print the server's address and port
